            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered tabla" style="font-size: 13px;" id="example" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php while ($row = $rel->fetch_assoc()) { ?>
                                <tr>
                                    <td><?= substr($row['nombre_blog'], 0, 70); ?></td>
                                    <td><?= $row['seccion_blog']; ?></td>
                                    <td>
                                        <form method="post" action='http://localhost/sjx/admin/editarBlog'>
                                            <input type="hidden" name="id_blog" id="id_blog" value="<?= $row['id_blog']; ?>" />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <h4>
                                Número de blog <span class="text-success"><strong><?= $numBlog ?></strong></span>
                            </h4>
                        </div>
                        <br><br>
                    </div>
