                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" 
                                type="text" readonly class="form-control" value="<?php echo $r; ?>">
                                <?php ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" type="text" 
                                readonly class="form-control" id="" value="<?php echo $sqlActive; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" type="text" 
                                readonly class="form-control" id="" value="<?php echo $numDanger; ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" type="text" 
                                readonly class="form-control" id="" value="<?= $sqlDias?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" type="text"
                                 readonly class="form-control" id="" value="<?= $sqlMeses  ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input style="background: white; color: green;" type="text" 
                                readonly class="form-control" id="" value="<?= $sqlAnio  ?>">
                            </div>
                        </div>
